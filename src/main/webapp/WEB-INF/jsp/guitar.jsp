...
<head>
  ...
  <title>吉他 - 静听网 - 140202011032_陈晓东</title>
  ...
  <div class="container">
    ...
    <nav>
      <ul class="nav navbar-nav navbar-link">
        ...
        <li class="active"><a href="/categorymusicView?cname=guitar">吉他</a></li>
...
<div class="container-sm category-header-wrap">
  <div class="category-header-banner">
    <div class="img"
         style="background-image: url('../../storage/category/guitar.jpg')">
      <div class="content">
        <h2>吉他</h2>
        <p>Guitar</p>
      </div>
